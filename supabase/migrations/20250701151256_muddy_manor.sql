/*
  ...
  3. Functions
    ...
    - Adds expired notification cleanup
*/
...
-- Create indexes for faster queries (IF NOT EXISTS prevents errors)
...
-- Create policies with existence checks to prevent errors
DO $$
BEGIN
