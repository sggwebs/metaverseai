/*
  ...
  1. New Tables
    - `investors`
      ...
      - `phone_number` (varchar, required, E.164 format)
      - `email` (varchar, required, unique)
      - `self_description` (text, optional, max 500 chars)
    ...
    - `investor_addresses`
      ...
      - `house_number` (varchar, required)
      - `street_name` (varchar, required)
      - `village` (varchar, optional)
      - `town` (varchar, optional)
    ...
    - `investment_profiles`
      ...
      - `investor_id` (uuid, foreign key)
      - `investment_experience` (varchar, enum)
      - `risk_tolerance` (varchar, enum)
      - `investment_timeline` (varchar, enum)
      - `annual_income_range` (varchar, optional)
      - `net_worth_range` (varchar, optional)
      - `investment_goals` (text array)
      - `preferred_sectors` (text array)
      - `investment_amount_range` (varchar, optional)
      - `has_investment_advisor` (boolean)
      - `previous_investments` (text array)
      - `created_at` (timestamptz)
      - `updated_at` (timestamptz)
...
DROP POLICY IF EXISTS "Users can create own investor profile" ON investors;
DROP POLICY IF EXISTS "Users can read own investor profile" ON investors;
DROP POLICY IF EXISTS "Users can update own investor profile" ON investors;
DROP POLICY IF EXISTS "Users can delete own investor profile" ON investors;
DROP POLICY IF EXISTS "Users can manage own addresses" ON investor_addresses;
DROP POLICY IF EXISTS "Users can manage own investment profiles" ON investment_profiles;
