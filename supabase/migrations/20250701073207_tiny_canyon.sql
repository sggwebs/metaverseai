/*
  # Add cover image storage and update user profiles

  1. New Storage Buckets
    - Create a new storage bucket for cover images
    - Set appropriate security policies

  2. Updates to user_profiles
    - Add cover_image_url field to store cover image references
    - Update RLS policies to allow users to manage their own images
*/
